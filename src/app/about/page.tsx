                    ...
                    <div className='mb-12 rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm'>
                        <div className='text-center'>
                            ...
                            <p className='mx-auto max-w-3xl leading-relaxed text-gray-300'>
                                Prompt AI is an intelligent tool designed to help you create better
                                prompts for AI models. Whether you're a content creator, developer,
                                or creative professional, our AI-powered system understands your
                                intent and crafts effective prompts that get superior results from
                                any AI model.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
                            <div className='text-center'>
                                ...
                                <p className='text-sm text-gray-300'>
                                    Enter your basic concept or question
                                </p>
                            </div>
                            <div className='text-center'>
                                <div className='mb-4 flex justify-center'>
                                    <div className='flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-r from-cyan-500 to-indigo-500'>
                                ...
                                <p className='text-sm text-gray-300'>
                                    Our AI analyzes and optimizes your input
                                </p>
                            </div>
                            <div className='text-center'>
                                <div className='mb-4 flex justify-center'>
                                ...
                                <p className='text-sm text-gray-300'>
                                    Receive a refined, effective prompt
                                </p>
                            </div>
                        </div>
                    </div>
